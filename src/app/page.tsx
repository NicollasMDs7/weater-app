...
export default function Home() {
  ...
  const [forecast, setForecast] = useState<{ date: string; temp_max: number; temp_min: number; icon?: string }[]>([]);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center">
          ...
          <div className="w-full md:w-2/3">
            ...
            {/* Exibir clima atual */}
            {!loading && weather && (
              <div className="bg-white/20 backdrop-blur-lg rounded-xl p-4 shadow-lg mb-2">
